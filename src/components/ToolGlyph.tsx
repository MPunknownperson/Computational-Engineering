...
export function BrandGlyph() {
  return <svg width="35" height="38" viewBox="0 0 38 40" aria-hidden="true" fill="none"><rect x="2" y="1" width="33" height="37" rx="7" fill="#3e5be8" /><path d="M10 10h17M13 18v9m-4-4.5h8M22 20h6m-6 5h6M9 32h19" stroke="white" strokeWidth="2" strokeLinecap="round" /><path d="M28 2h7v7" stroke="#d9b2ea" strokeWidth="3" strokeLinecap="round" /></svg>;
}